...
// rootNode.querySelector('#root ul').style.display = 'none';
...
function onMouseDown(e){
  ...
  if(e.target.id === 'rename' || e.target.id === 'delete') {
    ...
    if(e.target.id === 'delete') {
      console.log(elem.offsetParent.parentElement.querySelector('ul'))
      if (elem.offsetParent.parentElement.querySelector('ul')) {
        elem.offsetParent.innerHTML = ''
      } else {
        elem.offsetParent.innerHTML = 'Folder is empty'
      }
